  ...
  return <div>
    ...
    <section style={{ padding: "80px 24px", background: "#fff" }}><div style={{ maxWidth: 1200, margin: "0 auto" }}><ST badge="Confianza y transparencia" title={<>¿Por qué contratarnos<br />sin conocernos?</>} sub="Estas son las razones concretas y verificables por las que miles de personas confían en nosotros cada año." center />
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 20 }}>{[
        { icon: Shield, t: "Matrícula Oficial N° 10001", d: "Gestor Administrativo y Judicial habilitado ante los organismos de la Provincia de Buenos Aires. Podés verificarlo públicamente." },
        ...
        { icon: Star, t: "+312 reseñas 5 estrellas en Google", d: "Clientes reales que dan fe del trabajo. Cada reseña está verificada por Google y es pública. Podés leerlas antes de contratar." },
        ...
        { icon: MessageCircle, t: "Seguimiento activo por WhatsApp", d: "No desaparecemos después del pago. Informamos el estado de cada gestión y respondemos durante todo el proceso." },
    ...
    <section style={{ padding: "80px 24px", background: "#F1F3F5" }}><div style={{ maxWidth: 1200, margin: "0 auto" }}><ST badge="Nuestro compromiso" badgeColor="#25D366" title={<>Garantías escritas,<br />no promesas vacías</>} sub="Esto es lo que nos comprometemos a cumplir en cada gestión, sin excepciones." center />
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20, maxWidth: 1000, margin: "0 auto" }}>{[
        { n: "01", c: "#25D366", t: "Si el error es nuestro, lo corregimos sin costo", d: "Antes de presentar, revisamos cada dato y requisito. Si hay un error imputable a nuestra gestión, lo corregimos y reingresamos sin cobrar un peso adicional." },
        { n: "02", c: "#1D3557", t: "Presupuesto cerrado antes de empezar", d: "Acordamos el precio total por adelantado. No hay sorpresas al finalizar. El monto que te cotizamos es el monto que pagás, incluidos honorarios y timbrados." },
        { n: "03", c: "#F4A261", t: "Documentación oficial o no cobramos", d: "Todo lo que entregamos es documentación emitida por el organismo correspondiente, con firma digital y/o código QR verificable. Si no es oficial, no lo entregamos." }
...
export default function App() {
  ...
  return <div style={{ fontFamily: "'Inter',sans-serif", background: "#F1F3F5", minHeight: "100vh", color: "#212529", overflowX: "hidden", maxWidth: "100vw" }}>
    ...
    <div className="topbar" style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: "#0B1B2E", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "6px 24px", display: "flex", alignItems: "center", justifyContent: "center", gap: 32, fontFamily: "'Inter',sans-serif", fontSize: 12, color: "rgba(241,243,245,0.65)" }}>
    ...
    <nav className="mainnav" style={{ position: "fixed", top: 30, left: 0, right: 0, zIndex: 999, background: "rgba(19,36,55,0.97)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
