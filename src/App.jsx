...
const SERVICES = [
  { id: "registrales", icon: Landmark, title: "Servicios Registrales", scope: "PBA", desc: "Estudio de título, informes de dominio, cesión, inhibición e índice de titulares", color: "#457B9D",
    subs: [
  ...
  { id: "arba", icon: Building2, title: "ARBA y Catastro", scope: "PBA", desc: "Antecedentes catastrales, copias de plano, valuaciones y mesa de entrada", color: "#457B9D",
    subs: [
  ...
  { id: "actas", icon: ScrollText, title: "Actas e Inscripciones", scope: "PBA", desc: "Nacimiento, matrimonio, defunción, apostilla y Ley 22.172", color: "#457B9D",
    subs: [
...
function CookieBanner({ onPrivacy }) {
  ...
  return <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 1100, background: "rgba(29,53,87,0.97)", backdropFilter: "blur(12px)", borderTop: "1px solid rgba(255,255,255,0.08)", padding: "18px 24px", animation: "cookieSlide 0.4s ease-out" }}>
    <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20, flexWrap: "wrap" }}>
      <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 14, color: "rgba(241,243,245,0.8)", margin: 0, flex: 1, minWidth: 280, lineHeight: 1.6 }}>
...
const Bdg = ({ children, c = "#457B9D", lg }) => <span style={{ display: "inline-block", padding: lg ? "5px 14px" : "3px 10px", borderRadius: lg ? 6 : 4, background: c + "18", color: c, fontSize: lg ? 13 : 11, fontWeight: 600, letterSpacing: "0.5px", textTransform: "uppercase", fontFamily: "'Poppins',sans-serif" }}>{children}</span>;
...
function Btn({ children, v = "primary", href, onClick, style: s = {}, sm, full }) {
  ...
  const vs = { primary: { background: "#F4A261", color: "#fff", boxShadow: "0 4px 16px rgba(244,162,97,0.35)" }, outline: { background: "transparent", color: "#1D3557", border: "2px solid #1D3557" }, outlineW: { background: "transparent", color: "#fff", border: "2px solid rgba(255,255,255,0.4)" }, ghost: { background: "transparent", color: "#457B9D" }, green: { background: "#25D366", color: "#fff", boxShadow: "0 4px 16px rgba(37,211,102,0.35)" } };
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 380px", gap: 32, alignItems: "start" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          {(hasDatosGroups || (L.datos && L.datos.length > 0)) && <Card hover={false} style={{ padding: 0, overflow: "hidden" }}>
            <div style={{ padding: "28px 28px 4px" }}><h3 style={{ fontFamily: "'Poppins',sans-serif", fontWeight: 700, fontSize: 22, color: "#1D3557", margin: "0 0 6px", display: "flex", alignItems: "center", gap: 10 }}><div style={{ width: 36, height: 36, borderRadius: 8, background: "#457B9D14", display: "flex", alignItems: "center", justifyContent: "center" }}><FileText size={18} color="#457B9D" /></div>¿Qué datos necesitás?</h3><p style={{ fontFamily: "'Inter',sans-serif", fontSize: 14, color: "#457B9D", margin: "0 0 16px" }}>Si tenés dudas, envianos lo que tengas y nosotros nos ocupamos.</p></div>
            {hasDatosGroups ? <div style={{ padding: "0 20px 8px" }}>{L.datosGroups.map((g, i) => <Acc key={i} label={g.label} icon={g.icon} open={i === 0}>{g.items.map((item, j) => <div key={j} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}><CheckCircle2 size={15} color="#457B9D" style={{ flexShrink: 0 }} /><span style={{ fontFamily: "'Inter',sans-serif", fontSize: 14, color: "#212529" }}>{item}</span></div>)}</Acc>)}</div>
            : <div style={{ padding: "0 28px 16px" }}>{L.datos.map((d, i) => <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 8 }}><CheckCircle2 size={15} color="#457B9D" style={{ marginTop: 2, flexShrink: 0 }} /><span style={{ fontFamily: "'Inter',sans-serif", fontSize: 14, color: "#212529" }}>{d}</span></div>)}</div>}
            <div style={{ padding: "16px 28px 24px", background: "#F8F9FA", borderTop: "1px solid #E9ECEF" }}><div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}><Upload size={16} color="#F4A261" /><span style={{ fontFamily: "'Poppins',sans-serif", fontWeight: 600, fontSize: 14, color: "#1D3557" }}>¿No tenés todos los datos? No importa.</span></div><p style={{ fontFamily: "'Inter',sans-serif", fontSize: 14, color: "#457B9D", margin: "0 0 14px" }}>Envianos la documentación que tengas y nosotros nos encargamos.</p><Btn sm full href={wl(L.waDatos)} v="green"><MessageCircle size={14} /> Enviar datos por WhatsApp</Btn></div>
          </Card>}
          <Card hover={false}><h3 style={{ fontFamily: "'Poppins',sans-serif", fontWeight: 700, fontSize: 22, color: "#1D3557", margin: "0 0 20px", display: "flex", alignItems: "center", gap: 10 }}><div style={{ width: 36, height: 36, borderRadius: 8, background: "#457B9D14", display: "flex", alignItems: "center", justifyContent: "center" }}><Clock size={18} color="#457B9D" /></div>Plazos de gestión</h3><div style={{ display: "grid", gridTemplateColumns: plazosArr.length > 2 ? "repeat(3, 1fr)" : `repeat(${plazosArr.length}, 1fr)`, gap: 12 }}>{plazosArr.map((p, i) => { const Ic = p.icon; const isU = p.tipo.toLowerCase().includes("urgente") || p.tipo.toLowerCase().includes("express") || p.tipo.toLowerCase().includes("exprés"); return <div key={i} style={{ padding: 20, borderRadius: 10, background: isU ? "#FFF8F0" : "#F8F9FA", border: `1px solid ${isU ? "#F4A26130" : "#E9ECEF"}` }}><div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}><Ic size={18} color={isU ? "#F4A261" : "#457B9D"} /><span style={{ fontFamily: "'Poppins',sans-serif", fontWeight: 600, fontSize: 14, color: "#1D3557" }}>{p.tipo}</span></div><span style={{ fontFamily: "'Inter',sans-serif", fontSize: 18, fontWeight: 700, color: isU ? "#F4A261" : "#457B9D" }}>{p.tiempo}</span></div>; })}</div></Card>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20, position: "sticky", top: 88 }}>
          <div style={{ background: "#fff", borderRadius: 14, padding: 28, boxShadow: "0 4px 20px rgba(29,53,87,0.08)", border: "2px solid #F4A261" }}><div style={{ textAlign: "center", marginBottom: 20 }}><div style={{ fontFamily: "'Poppins',sans-serif", fontWeight: 700, fontSize: 18, color: "#1D3557" }}>Solicitá tu trámite</div><p style={{ fontFamily: "'Inter',sans-serif", fontSize: 13, color: "#457B9D", margin: "4px 0 0" }}>Presupuesto sin cargo · Respuesta inmediata</p></div><Btn full href={wl(L.wa)} style={{ marginBottom: 10 }}><MessageCircle size={18} /> Pedir presupuesto</Btn><Btn full sm href={wl(L.waDatos)} v="outline"><Upload size={14} /> Enviar datos / foto</Btn><div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 8 }}>{plazosArr.slice(0, 3).map((p, i) => <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 0" }}><Timer size={14} color="#457B9D" /><span style={{ fontFamily: "'Inter',sans-serif", fontSize: 13, color: "#457B9D" }}>{p.tipo}: {p.tiempo}</span></div>)}<div style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 0" }}><BadgeCheck size={14} color="#457B9D" /><span style={{ fontFamily: "'Inter',sans-serif", fontSize: 13, color: "#457B9D" }}>Documentación oficial</span></div><div style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 0" }}><Shield size={14} color="#457B9D" /><span style={{ fontFamily: "'Inter',sans-serif", fontSize: 13, color: "#457B9D" }}>Asesoramiento incluido</span></div></div></div>
          ...
          <div style={{ background: "#F8F9FA", borderRadius: 14, padding: 24, border: "1px solid #E9ECEF", textAlign: "center" }}><p style={{ fontFamily: "'Inter',sans-serif", fontSize: 14, color: "#457B9D", margin: "0 0 12px" }}>¿Precisás asesoramiento antes de pedirlo?</p><Btn sm full href={wl(L.waAsesor)} v="ghost"><MessageCircle size={14} /> Consultá con un Asesor</Btn></div>
        </div>
      </div>
    </section>
  </div>;
  ...
  return <div>
    ...
    <section style={{ padding: "60px 24px", background: "#F1F3F5" }}><div style={{ maxWidth: 1200, margin: "0 auto" }}><ST badge="Servicios" title="Elegí el que necesitás" />
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: 20 }}>{s.subs.map(sub => <Card key={sub.id} onClick={() => nav("sub", s.id, sub.id)} style={{ borderLeft: `4px solid ${s.color}` }}>
        ...
        <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 14, color: "#457B9D", lineHeight: 1.6, margin: "0 0 12px" }}>{sub.desc}</p>
  ...
  return <div>
    ...
    <section style={{ padding: "60px 24px", background: "#F1F3F5" }}><div style={{ maxWidth: 1200, margin: "0 auto" }}><ST badge="Trámites" title="Identificá tu situación" />
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 20 }}>{sub.landings.map(l => <Card key={l.id} onClick={() => nav("landing", s.id, sub.id, l.id)} style={{ borderLeft: "4px solid #F4A261" }}>
        ...
        <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 14, color: "#457B9D", lineHeight: 1.5, margin: "0 0 12px" }}>{l.intro.substring(0, 120)}...</p>
        <div style={{ display: "flex", alignItems: "center", gap: 4, color: "#F4A261", fontFamily: "'Poppins',sans-serif", fontSize: 13, fontWeight: 600 }}>VER DETALLE <ChevronRight size={16} /></div>
      </Card>)}</div>
    </div></section>
  </div>;
    ...
    <section style={{ padding: "60px 24px", background: "#F1F3F5" }}><div style={{ maxWidth: 800, margin: "0 auto" }}>
      <Card hover={false} style={{ marginBottom: 24 }}>
        <S t="1. Responsable del tratamiento">
          ...
          <p style={{ margin: 0 }}>Contacto: <strong>gestorlaplata.ok@gmail.com</strong> · WhatsApp: <strong>221-488-6197</strong></p>
        </S>
        ...
        <S t="7. Tus derechos">
          ...
          <p style={{ margin: 0 }}>Para ejercer estos derechos, escribinos a <strong>gestorlaplata.ok@gmail.com</strong> o por WhatsApp al <strong>221-488-6197</strong>.</p>
        </S>
        <S t="8. Seguridad">
        ...
        <S t="10. Contacto">
          <p style={{ margin: 0 }}>Si tenés dudas o consultas sobre esta Política de Privacidad, podés comunicarte con nosotros a través de <strong>gestorlaplata.ok@gmail.com</strong> o por WhatsApp al <strong>221-488-6197</strong>.</p>
        </S>
      </Card>
      ...
      <Card hover={false} style={{ marginBottom: 24 }}>
        ...
        <S t="2. ¿Qué tipos de cookies usamos?">
          ...
          <div style={{ background: "#F8F9FA", borderRadius: 10, padding: 20, marginBottom: 12, border: "1px solid #E9ECEF" }}>
            ...
            <p style={{ margin: "0 0 4px", fontSize: 14, color: "#457B9D" }}>Son imprescindibles para que el sitio funcione correctamente.</p>
          ...
          <div style={{ background: "#F8F9FA", borderRadius: 10, padding: 20, marginBottom: 12, border: "1px solid #E9ECEF" }}>
            ...
            <p style={{ margin: "0 0 4px", fontSize: 14, color: "#457B9D" }}>Nos ayudan a entender cómo interactúan los visitantes con el sitio.</p>
          ...
          <div style={{ background: "#F8F9FA", borderRadius: 10, padding: 20, border: "1px solid #E9ECEF" }}>
            ...
            <p style={{ margin: "0 0 4px", fontSize: 14, color: "#457B9D" }}>Provienen de servicios externos integrados en nuestro sitio.</p>
        ...
        <S t="5. ¿Cómo gestionar las cookies?">
          ...
          <p style={{ margin: "0 0 4px", fontSize: 14, color: "#457B9D" }}>Configuración por navegador:</p>
          ...
          <p style={{ margin: 0, fontSize: 14, color: "#457B9D" }}>Tené en cuenta que bloquear todas las cookies puede afectar el funcionamiento de algunos elementos del sitio.</p>
        </S>
        <S t="6. Base legal">
        ...
        <S t="8. Contacto">
          <p style={{ margin: 0 }}>Si tenés consultas sobre nuestra Política de Cookies, escribinos a <strong>gestorlaplata.ok@gmail.com</strong> o por WhatsApp al <strong>221-488-6197</strong>.</p>
        </S>
      </Card>
      <div style={{ textAlign: "center", marginTop: 24 }}><Btn sm onClick={() => nav("home")} v="outline"><ChevronLeft size={14} /> Volver al inicio</Btn></div>
    </div></section>
...
const SLUGS = {
  ...
  "copias-reg": "copias-registrales",
  "estudio-titulo": "estudio-de-titulos",
  "plancheta-l": "plancheta-catastral",
  "plano-l": "copia-de-plano",
  "valuacion-l": "valuacion-fiscal",
  "agrimensores-l": "gestoria-para-agrimensores",
  "actas-l": "busqueda-de-actas",
  "divorcio-l": "inscripcion-de-divorcio",
  "apostilla-l": "apostilla-de-la-haya",
  "alta-l": "habilitacion-comercial-la-plata",
  "transferencia-l": "transferencia-de-habilitacion",
  "baja-l": "baja-de-habilitacion",
  "eventos-l": "permiso-para-eventos",
  "publicidad-l": "publicidad-y-mesas-y-sillas",
  "reba-l": "licencia-reba",
  // Páginas estáticas
  about: "quienes-somos",
  ...
  useEffect(() => {
    ...
    if (!schemaScript) {
      ...
      schemaScript.textContent = JSON.stringify({
        ...
        "email": "gestorlaplata.ok@gmail.com",
        "address": { "@type": "PostalAddress", "streetAddress": "Calle 49 N° 1296", "addressLocality": "La Plata", "addressRegion": "Buenos Aires", "addressCountry": "AR" },
