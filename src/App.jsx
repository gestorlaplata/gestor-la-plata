...
const ST = ({ badge, title, sub, light, center, badgeColor }) => <div style={{ marginBottom: 48, maxWidth: center ? 900 : 700, textAlign: center ? "center" : "left", margin: center ? "0 auto 48px" : undefined }}>{badge && <Bdg c={badgeColor || (light ? "#F4A261" : "#3B6B8A")} lg>{badge}</Bdg>}<h2 style={{ fontFamily: "'Poppins',sans-serif", fontWeight: 700, fontSize: "clamp(30px,4vw,42px)", color: light ? "#fff" : "#1D3557", margin: "14px 0 8px", lineHeight: 1.15 }}>{title}</h2>{sub && <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 17, color: light ? "rgba(255,255,255,0.75)" : "#3B6B8A", lineHeight: 1.6, margin: 0 }}>{sub}</p>}</div>;
...
function HomePage({ nav }) {
  ...
  return <div>
    ...
    <section id="srv" style={{ padding: "80px 40px", background: "#F1F3F5" }}><div style={{ maxWidth: 1140, margin: "0 auto" }}><ST badge="Nuestros servicios" title={<>Encontrá la solución <span style={{ color: "#F4A261" }}>para tu trámite</span></>} sub="5 áreas de gestión especializadas." />
    ...
    <section style={{ padding: "80px 40px", background: "#fff" }}><div style={{ maxWidth: 1140, margin: "0 auto" }}><ST badge="Confianza y transparencia" title={<>¿Por qué contratarnos<br /><span style={{ color: "#F4A261" }}>sin conocernos?</span></>} sub="Estas son las razones concretas y verificables por las que miles de personas confían en nosotros cada año." />
    ...
    <section style={{ padding: "80px 40px", background: "#F1F3F5" }}><div style={{ maxWidth: 1140, margin: "0 auto" }}><ST badge="Nuestro compromiso" badgeColor="#25D366" title={<>Garantías escritas,<br /><span style={{ color: "#F4A261" }}>no promesas vacías</span></>} sub="Esto es lo que nos comprometemos a cumplir en cada gestión, sin excepciones." />
...
export default function App() {
  ...
  return <div style={{ fontFamily: "'Inter',sans-serif", background: "#F1F3F5", minHeight: "100vh", color: "#212529", overflowX: "hidden", maxWidth: "100vw" }}>
    ...
    <div className="topbar" style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: "#0B1B2E", height: scrolled ? 0 : 32, opacity: scrolled ? 0 : 1, overflow: "hidden", pointerEvents: scrolled ? "none" : "auto", display: "flex", alignItems: "center", transition: "height 0.25s ease, opacity 0.25s ease" }}>
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "flex-start", gap: 10, fontFamily: "'Inter',sans-serif", fontSize: 12, color: "rgba(241,243,245,0.65)", width: "100%" }}>
        <a href={GOOGLE_REVIEWS_URL} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "#F4A261", textDecoration: "none" }}><Star size={12} fill="#F4A261" color="#F4A261" /> <strong style={{ fontWeight: 600 }}>5.0 Google</strong></a>
        <span style={{ color: "rgba(241,243,245,0.3)" }}>·</span>
        <a href={GOOGLE_REVIEWS_URL} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", color: "rgba(241,243,245,0.65)", textDecoration: "none" }}>+337 reseñas</a>
        <span style={{ color: "rgba(241,243,245,0.3)" }}>·</span>
        <span style={{ display: "inline-flex", alignItems: "center" }}>Mat. 10001</span>
      </div>
    </div>
    <nav className="mainnav" style={{ position: "fixed", top: scrolled ? 0 : 32, left: 0, right: 0, zIndex: 999, background: "rgba(19,36,55,0.97)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(255,255,255,0.06)", transition: "top 0.25s ease"}}>
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 32px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div onClick={() => nav("home")} role="button" aria-label="Ir al inicio - Gestor La Plata" style={{ cursor: "pointer", display: "flex", alignItems: "center", gap: 10, marginRight: 32, flexShrink: 0 }}><img src="/isotipo-glp.png" alt="Gestor La Plata" width="52" height="52" style={{ width: 52, height: 52, objectFit: "contain", display: "block" }} /><span style={{ fontFamily: "'Poppins',sans-serif", fontWeight: 700, fontSize: 15, color: "#F1F3F5", whiteSpace: "nowrap" }}>GESTOR <span style={{ color: "#F4A261", fontWeight: 700 }}>LA PLATA</span></span></div>
