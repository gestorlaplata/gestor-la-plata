...
function HomePage({ nav }) {
  ...
  return <div>
    ...
    <section style={{ padding: "80px 40px", background: "#fff" }}><div style={{ maxWidth: 1140, margin: "0 auto" }}><ST num="02" badge="Confianza y transparencia" title={<>¿Por qué contratarnos<br /><span style={{ color: "#F4A261" }}>sin conocernos?</span></>} sub="Estas son las razones concretas y verificables por las que miles de personas confían en nosotros cada año." />
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 20 }}>{[
        ...
        { icon: Star, t: "+337 reseñas 5 estrellas en Google", d: "Podés leerlas antes de iniciar la gestión." },
    ...
    <section style={{ padding: "80px 40px", background: "#F1F3F5" }}><div style={{ maxWidth: 1140, margin: "0 auto" }}><ST num="03" badge="Nuestro compromiso" badgeColor="#25D366" title={<>Garantías escritas,<br /><span style={{ color: "#F4A261" }}>no promesas vacías</span></>} sub="Esto es lo que nos comprometemos a cumplir en cada gestión, sin excepciones." />
  ...
  return <div style={{ fontFamily: "'Inter',sans-serif", background: "#F1F3F5", minHeight: "100vh", color: "#212529", overflowX: "hidden", maxWidth: "100vw" }}>
    ...
    <div className="topbar" style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: "#16233A", height: scrolled ? 0 : 32, opacity: scrolled ? 0 : 1, overflow: "hidden", pointerEvents: scrolled ? "none" : "auto", display: "flex", alignItems: "center", transition: "height 0.25s ease, opacity 0.25s ease" }}>
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "flex-start", gap: 10, fontFamily: "'Inter',sans-serif", fontSize: 12, color: "#F1F3F5", width: "100%" }}>
        ...
        <a href={GOOGLE_REVIEWS_URL} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", color: "#F1F3F5", textDecoration: "none" }}>+337 reseñas</a>
        <span style={{ color: "rgba(255,255,255,0.5)" }}>·</span>
