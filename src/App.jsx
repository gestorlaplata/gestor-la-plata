        ...
        landings: [
          ...
          { id: "titularidad", title: "Índice de Titularidad",
            ...
            faq: [
              ...
              { q: "¿La búsqueda es en toda la Provincia o solo en un partido?", a: "Se puede pedir provincial (abarca los 135 partidos de la Provincia de Buenos Aires) o acotada a un partido específico. La búsqueda provincial es la más completa y es la que recomendamos en sucesiones, juicios de divorcio y verificaciones patrimoniales serias. La búsqueda por partido es más económica pero solo sirve cuando ya sabés que los bienes están en una jurisdicción determinada. Si tenés dudas, conviene ir por la provincial." },
              ...
              { q: "¿Cuál es la vigencia del informe?", a: "90 días corridos desde la fecha de emisión. Pasado ese plazo, la información deja de considerarse actualizada para la mayoría de los usos procesales y hay que pedir un informe nuevo. Si tu audiencia o escritura se va a concretar cerca del vencimiento, lo ideal es pedirlo unos días antes de la fecha clave para que llegue vigente." },
          ...
          { id: "anotaciones", title: "Anotaciones Personales",
            ...
            faq: [
              ...
              { q: "¿Qué me devuelve el informe?", a: "El resultado es binario y oficial. Si la persona está inhibida o cedió derechos, el informe detalla el acto inscripto: fecha, jurisdicción, tipo de medida. Si no tiene anotaciones, devuelve un informe negativo oficial del RPBA, que también sirve como prueba documental de que la persona puede disponer libremente de sus bienes." },
              { q: "¿Cuál es la vigencia del informe?", a: "90 días corridos desde la fecha de emisión. Para escrituras, lo ideal es pedirlo unos días antes de la firma para que llegue vigente al escribano. Para garantías de alquiler o verificaciones comerciales también conviene renovarlo cada vez que se hace una nueva operación." },
      ...
      { id: "investigacion", title: "Investigación y Estudio de Títulos", desc: "Rastreo de antecedentes desde cero",
        landings: [{ id: "estudio-titulo", title: "Estudio de Títulos",
          ...
          faq: [
            ...
            { q: "¿Qué datos mínimos necesito aportar?", a: "Idealmente: escritura o fotocopia. Si no la tenés, sirve cualquier referencia: dirección exacta, partida de ARBA, algún impuesto, informes antiguos, papeles viejos del inmueble. Nos especializamos en casos con datos fragmentarios: cuanto menos tengas, más valor agrega el trabajo de investigación." },
            ...
            { q: "¿Cuánto cuesta?", a: "El costo varía según complejidad. No cotizamos sin conocer el caso porque un inmueble matriculado sencillo cuesta muy distinto que una reconstrucción de Folio Antiguo con múltiples sucesiones. Pasanos los datos por WhatsApp y te damos un presupuesto concreto. En operaciones inmobiliarias importantes, el costo del estudio es mínimo frente al valor del inmueble y la seguridad que aporta." },
          ],
        }]
      },
    ]
    ...
    subs: [
      { id: "plancheta", title: "Plancheta Catastral y Cédulas", desc: "Documentación gráfica y administrativa ante ARBA", landings: [{ id: "plancheta-l", title: "Plancheta Catastral",
        ...
        faq: [
          ...
          { q: "¿Sirve para una habilitación comercial?", a: "Sí. Para habilitaciones comerciales la Municipalidad de La Plata suele pedir la superficie oficial del local, y la Plancheta es el documento que lo acredita. Si estás gestionando una habilitación con nosotros, coordinamos la Plancheta en paralelo." },
      ...
      { id: "agrimensores", title: "Mesa de Entrada para Agrimensores", desc: "Ingreso, seguimiento y retiro", landings: [{ id: "agrimensores-l", title: "Gestión para Agrimensores",
        ...
        riesgos: [], review: null,
        faq: [
          { q: "¿Qué servicios cubre la Mesa de Entrada para Agrimensores?", a: "Somos el nexo profesional de agrimensores y estudios técnicos ante la Dirección de Catastro de ARBA. Ingresamos documentación a mesa de entrada, hacemos el seguimiento activo del expediente, diligenciamos reingresos cuando ARBA observa, y retiramos trámites finalizados. El agrimensor delega toda la logística administrativa y conserva el tiempo de trabajo técnico y de campo." },
          { q: "¿Por qué conviene delegar este trabajo?", a: "El tiempo de un agrimensor matriculado vale mucho más trabajando en campo, firmando planos o haciendo el trabajo técnico que esperando turnos en ARBA o haciendo seguimiento de expedientes. Al delegar la mesa de entrada, el profesional multiplica su productividad: trabaja en paralelo con más proyectos sin perder horas en tareas administrativas." },
          { q: "¿Qué tipo de trámites ingresan habitualmente?", a: "Mensuras, divisiones en PH, subdivisiones, unificaciones, modificaciones, planos de obra, rectificaciones de medidas. Cualquier trabajo técnico del agrimensor que tenga que presentarse ante Catastro. También gestionamos las respuestas a observaciones de ARBA y los reingresos hasta que el trabajo queda aprobado." },
          { q: "¿Hacen el seguimiento o solo el ingreso?", a: "Hacemos seguimiento activo. Consultamos periódicamente el estado del expediente, te avisamos apenas hay movimiento, coordinamos el retiro o la respuesta a observaciones. No te dejamos con el expediente ingresado sin noticias: la información del estado está actualizada en todo momento." },
          { q: "¿Qué pasa si ARBA observa el trámite?", a: "Te avisamos inmediatamente con el detalle de la observación. Vos resolvés el tema técnico (ajuste de plano, documentación faltante, corrección de datos) y nosotros hacemos el reingreso con la respuesta. El circuito de observación-respuesta-reingreso es una de las partes más tediosas del trabajo y es donde más valor agrega delegar." },
          { q: "¿Cómo se coordina con profesionales del interior de PBA?", a: "Toda la coordinación es por WhatsApp. Nos mandás la documentación digitalmente, nos indicás qué trámite presentar y cualquier instrucción particular. El trabajo físico (ingreso en mesa de entrada en La Plata) lo hacemos nosotros. Funciona igual para profesionales de La Plata que de cualquier otro partido de PBA." },
          { q: "¿Qué documentación necesitan?", a: "La documentación del trámite que vas a presentar (planos firmados, formularios, carátulas), los datos del expediente si ya existe uno previo, y cualquier instrucción particular sobre el trámite. Si es la primera vez que trabajamos juntos, coordinamos una primera reunión (remota o presencial) para conocer tu forma de trabajo." },
          { q: "¿Cobran por trámite o por mensualidad?", a: "Trabajamos por trámite en la mayoría de los casos, porque es más equitativo según el volumen real. Para estudios con flujo constante de expedientes, evaluamos esquemas de tarifa mensual con volumen acordado. Pasanos tu volumen habitual por WhatsApp y armamos la propuesta más conveniente." },
          { q: "¿Trabajan también con otros profesionales (arquitectos, ingenieros)?", a: "Sí. Aunque el servicio nació para agrimensores, también trabajamos con arquitectos que tramitan ante Catastro (planos de PH, mensuras previas a obra) y con ingenieros o estudios técnicos que requieren presentar documentación en ARBA. El circuito es similar." },
          { q: "¿Cómo arranco si quiero probar el servicio?", a: "Escribinos por WhatsApp contándonos qué tipo de trámites hacés y con qué frecuencia. Te damos una propuesta concreta y, si querés, empezamos con un expediente de prueba para que veas cómo trabajamos. Muchos de nuestros clientes arrancaron así y hoy nos derivan todo el flujo de mesa de entrada." },
        ],
        }] },
    ]
  },
    ...
    subs: [
      ...
      { id: "apostilla", title: "Apostilla de la Haya", desc: "Validación para el exterior", landings: [{ id: "apostilla-l", title: "Apostilla de la Haya",
        ...
        faq: [
          ...
          { q: "¿El documento tiene que estar vigente?", a: "Los documentos del Registro Civil (nacimiento, matrimonio, defunción) no caducan. Pueden apostillarse aunque el acta sea antigua. Los títulos educativos tampoco caducan. Los documentos notariales (poderes) sí pueden tener vigencia acotada según el acto. Antes de apostillar, conviene verificar que el documento sea el adecuado para el trámite de destino." },
          { q: "¿Puedo apostillar una fotocopia?", a: "No. La apostilla se coloca sobre el documento original emitido por el funcionario público. Si necesitás apostillar un acta y no tenés el original, primero gestionamos la obtención del acta oficial del Registro (servicio que también ofrecemos) y después apostillamos. Lo coordinamos como trámite encadenado." },
